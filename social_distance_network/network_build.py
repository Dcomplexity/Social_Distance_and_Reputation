...
# get potential pos for method in paper
...
# my approach for build a new dimension
...
# Build a new dimension used in the paper
...
# my approach to build a new dimension that can be used to present the heterogeneity
...
def generate_er_random_connected(mul_dimen, degree, group_size, group_base, group_length, dimen_l, alpha, beta):
